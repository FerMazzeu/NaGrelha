...
const orcamento: Orcamento = {
  ...
  selecionados: ['a', 'b', 'c'],
  servicos: [
    { id: 's1', servicoId: 's1', nome: 'Churrasqueiro', papel: 'equipe', pessoa: 'Alan', quantidade: 1, valor: 600 },
    { id: 's2', servicoId: 's2', nome: 'Organização (metrê)', papel: 'equipe', pessoa: 'Érica', quantidade: 1, valor: 600 },
    { id: 's3', servicoId: 's3', nome: 'Frete', papel: 'frete', pessoa: 'Eduardo', quantidade: 2, valor: 50 },
    { id: 's4', servicoId: 's4', nome: 'Imposto (DAS)', papel: 'imposto', pessoa: '', quantidade: 1, valor: 325 },
  ],
  custosExtras: [],
  margem: 0,
  fatorCarvao: 0.5,
